// Copyright (c) 2023, Ala Alsalam Pvt. Ltd. and contributors
// For license information, please see license.txt

frappe.ui.form.on('Scheduling Tool', {
	// setup(frm) {
	...
	// 	frm.add_fetch('academic_term', 'course_start_date', 'term_start_date');
	// 	frm.add_fetch('academic_term', 'course_end_date', 'term_end_date');
	...
	refresh(frm) {
		...
		frm.page.set_primary_action(__('Schedule Course'), () => {
			...
			frm.call('schedule_table_course')
				.fail(() => {
					frappe.dom.unfreeze();
